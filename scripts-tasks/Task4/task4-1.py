...
if __name__ == "__main__":
    ...
    time_of_day_df = fully_joined_df.select("time_of_day", "driver_total_pay")
    ...
    avg_drive_total_pay_df = spark.createDataFrame(data, ["time_of_day", "average_drive_total_pay"])

    # ordering dataframe by average_drive_total_pay
    avg_drive_total_pay_df = avg_drive_total_pay_df.orderBy(col("average_drive_total_pay").desc())

    # printing resulting dataframe 
    avg_drive_total_pay_df.show()
